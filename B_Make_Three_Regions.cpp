...
void Solve()
{
    ...
    int ans=0;
    F(2,n,1,i){
        // cout<<v[0][i-2]<<' '<<v[0][i-1]<<' '<<v[0][i]<<endl;
        // cout<<v[1][i-2]<<' '<<v[1][i-1]<<' '<<v[1][i]<<endl;
        if(v[0][i-2]=='.'&&v[0][i-1]=='.'&&v[0][i]=='.'&&v[1][i-2]=='x'&&v[1][i-1]=='.'&&v[1][i]=='x'){ans++;}
        if(v[1][i-2]=='.'&&v[1][i-1]=='.'&&v[1][i]=='.'&&v[0][i-2]=='x'&&v[0][i-1]=='.'&&v[0][i]=='x'){ans++;}
    }
    cout<<ans<<endl;
