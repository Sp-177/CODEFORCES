...
#define p(a,i)	for(auto i:a){cout<<i<<" ";}cout<<endl
#define P(a,x)	for(auto i:a){cout<<i.x<<" ";}cout<<endl
...
// Compartor Func
static const bool cmp(auto&a,auto&b){
	if(a>b)return true;
	else if(a==b)return a>b;
	return false;}
