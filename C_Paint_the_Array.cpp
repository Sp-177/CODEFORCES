...
void Solve()
{
    int n;cin>>n;vl v(n);inp(v);
    ll gcd1=v[0],gcd2=v[1];
    F(0,n,2,i){gcd1=__gcd(gcd1,v[i]);}
    F(1,n,2,i){gcd2=__gcd(gcd2,v[i]);}
    bool ans1=true,ans2=true;
    F(0,n,2,i){if(v[i]%gcd2==0){ans1=false;break;}}
    if(ans1){cout<<gcd2<<endl;}
    else{
    F(1,n,2,i){if(v[i]%gcd1==0){ans2=false;break;}}
    if(ans2){cout<<gcd1<<endl;}
    else{cout<<0<<endl;}}
